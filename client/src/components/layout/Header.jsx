...
const Header = () => {
  ...
  return (
    <header className="w-full px-4 h-[10vh] border-b border-neutral-800 flex justify-between items-center">
      {/* Logo and Desktop Navigation */}
      <NavLink to="/" className="flex items-center gap-2">
        <h1 className="text-2xl flex items-center">
          News
          <span className="font-semibold rounded-md bg-white text-xl text-black py-1 px-0.5">
            .dev
          </span>
        </h1>
      </NavLink>
        ...
        {navOpen && (
          <div className="fixed z-50 top-0 right-0 w-[70%] h-full bg-black p-5">
            <div className="flex flex-col items-end gap-5">
              ...
              <button className="text-2xl font-semibold" onClick={toggleNav}>
                Close
              </button>
            </div>
          </div>
