...
//         const response = await axios.get(`http://localhost:5500/api/blog/single-blog/${id}`);
...
//     try {
//       const response = await axios.post(`http://localhost:5500/api/blog/comment`, {
//         text: newCommentText,
//         blogId: blog._id,
//       });
...
//       try {
//         const response = await axios.get(`http://localhost:5500/api/blog/comment/${id}`);
